...
class Hi2PDF_Settings {
	...
	public function add_menu_item () {
		...
		// main menu
		$page = add_menu_page( 'DK PDF', 'DK PDF', 'manage_options', 'hi2pdf' . '_settings',  array( $this, 'settings_page' ) );
	...
	public function settings_assets () {
    	...
    	wp_register_script( 'hi2pdf' . '-settings-js', plugins_url( 'hi2pdf/assets/js/settings-admin.js' ), array( 'farbtastic', 'jquery' ), '1.0.0' );
